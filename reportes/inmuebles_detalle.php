...
<div class="d-flex justify-content-between align-items-center mb-3">
  <h2>Reporte de inmuebles</h2>
  <a class="btn btn-outline-secondary" href="index.php?a=inmuebles">Volver</a>
</div>

<form class="row g-2 mb-3" method="get" action="index.php">
  <input type="hidden" name="a" value="reporte_inmuebles">
